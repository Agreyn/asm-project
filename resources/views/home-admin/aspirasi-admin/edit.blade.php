   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form class="row" action="" method="post" enctype="multipart/form-data">
         ...
         <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" id="judul_laporan" name="judul" value="{{ $aspirasi->judul }}" readonly>
         </div>
         <div class="col-md-6 mb-2">
            <label for="alamat" class="form-label">Alamat Asal Pelapor *</label>
            <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $aspirasi->alamat }}" readonly>
         </div>
